...
$bvmain = new LiquidWeb();

register_uninstall_hook(__FILE__, array('LiquidWeb', 'uninstall'));
...
if (is_admin()) {
	...
	##ACTIVATEWARNING##
	add_action('admin_enqueue_scripts', array($bvadmin, 'lwsecAdminMenu'));
}
