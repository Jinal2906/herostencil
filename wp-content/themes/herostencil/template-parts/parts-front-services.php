            ...
            while ( have_rows('services_list') ) :
                ...
                echo '<li class=" position-relative d-block cell-4 p-15 cell-992-6 cell-480-12 ">' .
                        '<div class="service-image innbaner image-src pt-75 cell-12 mb-10 position-relative block-animate">' .
                            ...
                            '<div class="service-content width-full height-full p-15 d-flex justify-content-center align-content-center position-absolute position-top-0-px position-left-0-px transition opacity-0 ">' .
                                (
                                    get_sub_field('service_title')
                                    ? '<h3 class="mb-10">' . get_sub_field('service_title') . '</h3>'
                                    : ''
                                ) .
                                (
